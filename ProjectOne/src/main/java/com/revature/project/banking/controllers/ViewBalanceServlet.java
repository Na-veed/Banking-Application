...
public class ViewBalanceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int customerId = Integer.parseInt((String)session.getAttribute("customerId"));		//String userName = (String) session.getAttribute("userName");
		...
		out.write("<br><br>");
		out.write("<h5>Account Balance for Customer Id  " + customerId + " is  " + balance + " </h5>");
		out.write("<br><br>");
