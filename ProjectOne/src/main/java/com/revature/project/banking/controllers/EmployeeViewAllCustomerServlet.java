...
/**
 * Servlet implementation class EmployeeViewAllCustomerServlet
 */
public class EmployeeViewAllCustomerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeViewAllCustomerServlet() {
        super();
